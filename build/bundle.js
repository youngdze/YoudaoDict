...
/***/ function(module, exports, __webpack_require__) {
	...
	var Youdao = __webpack_require__(7);
	  ...
	  _createClass(Module, null, [{
	    ...
	    value: function getTemplate() {
	      return new Promise(function (resolve, reject) {
	        ...
	        var templateUrl = chrome.extension.getURL('template/bubble.html');
	    ...
	    key: 'injectData',
	    value: function injectData(template, data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./bubble.less", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./bubble.less");
	    ...
	    _createClass(Youdao, [{
	        ...
	        value: function parseXmlContent(res) {
	            ...
	            if (_.isNull(res) || _.isEmpty(res)) {
	                ...
	                explains = [];
	                for (var i = 0; i < _.size(explainsNode); i++) {
	                ...
	                if (_.size(relates)) {
	                    for (var i = 0; i < _.size(relates); i++) {
	                        var dummy = {};
	                        dummy.key = relates[i].querySelector('key').textContent;
	                        dummy.relate = [];

	                        for (var j = 0; j < _.size(relates[i].querySelector('value').querySelectorAll('ex')); j++) {
	                ...
	                req.onload = function () {
	                    if (Object.is(req.readyState, 4)) {
	                        if (Object.is(req.status, 200)) {
	                            ...
	                            var result = Object.is(_this.resType.toLowerCase(), 'xml') ? _this.parseXmlContent(res) : _this.parseJsonContent(res);
	                            resolve(result);
	                        } else {
